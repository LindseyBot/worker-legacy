...
import net.lindseybot.legacy.repositories.sql.MemberRepository;
import net.lindseybot.legacy.repositories.sql.ServerRepository;
import net.lindseybot.legacy.repositories.sql.UserRepository;
